...
class GantryMovePart(smach.State):
    ...
    def execute(self, ud):
        ...
        if 'regulator' in ud.part.type:
            self.rm.move_directly_gantry([ud.partcurrentpose.position.x + 0.2, ud.partcurrentpose.position.y - (0.5 * multiplier), ud.partcurrentpose.position.z + 0.75, 0, pi, pi/2 * multiplier], 1)
            rospy.sleep(1.5)
            self.rm.move_directly_gantry([ud.partcurrentpose.position.x + 0.2, ud.partcurrentpose.position.y - (0.3 * multiplier), ud.partcurrentpose.position.z + 0.75, -pi/2, pi, pi/2  * multiplier], 1)
        elif 'sensor' in ud.part.type:
            self.rm.move_directly_gantry([ud.partcurrentpose.position.x + 0.2, ud.partcurrentpose.position.y - (0.5 * multiplier), ud.partcurrentpose.position.z + 0.75, pi/2, 0, pi/2 * multiplier], 1)
            rospy.sleep(1.5)
            ...
            self.rm.move_directly_gantry([ud.partcurrentpose.position.x + 0.2, ud.partcurrentpose.position.y - (0.5 * multiplier), ud.partcurrentpose.position.z + 0.75, 0, pi/2, 0], 1)
        rospy.sleep(1.2)
